...
class Barra():
    ...
    def click_de_mouse(self, evento):
        actor_actual = pilas.actores.utils.obtener_actor_en(evento.x, evento.y)
        if isinstance(actor_actual, Item):
            print pilas.actores.utils.obtener_actor_en(evento.x, evento.y)
